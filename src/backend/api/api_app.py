...
from backend.api.routes.speed_test_routes import router as speedtests_router
from backend.api.routes.connection_routes import router as connection_router
from backend.api.routes.logs_routes import router as log_router
from backend.api.routes.outages_routes import router as outage_router
